 ...
 * *****************************************************************************
 */
#ifndef __GAMEBOY_SETTINGS_HPP__
#define __GAMEBOY_SETTINGS_HPP__
...
struct GameboySettings : public RomSettings{
    GameboySettings();

	virtual ~GameboySettings() {}
...
#endif // __GAMEBOY_SETTINGS_HPP__
